    ...
    <div class="chapter-container">
        <div class="chapter-article">
            ...
            <ul>
                ...
                <li>屬於Class的變數, 稱為Class Variable(類別變數)</li>
            ...
            <p>
                Java規定公共類別(public
                class)必須寫在該公共類別名稱的.java檔案內, 例如public
                class
                ...
                不同處在於每個java class都可以定義自己的public static
...
public class Example {
    public static void main(String[] argv) {
        ...
        System.out.println("There are "+Vehicle.totalVehicle()+" Vehicles in the world.\n");
            ...
            <ul>
                ...
                <li>
                    System.out是class System裡面的一個Class Variable,
                    其型態為reference to 定義於java.io
    ...
    public void print(int msg, String others) {
            ...
            <ol>
                <li>
                    先將所有變數設為內定值。對數值型態來說,
                    其值為0;對reference來說, 其值為null;對boolean來說,
                    其值為false。
                </li>
